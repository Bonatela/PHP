/*Guilherme Bonato, Jonathan Pertile Morales, Germano Papke */
...
void Player1(void)
{
	...
	///Player 1
	glPushMatrix(); glColor3f(0,0,1); 	glTranslatef(player1.x + -15,8,player1.y + 0); glScalef(1,2,1); glutSolidCube(1); 	glPopMatrix();

	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player1.x + -15,5,player1.y + 0); glScalef(1,4,2); glutSolidCube(1); 	glPopMatrix();

	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player1.x + -15,3,player1.y + 1); glScalef(1,4,1); glutSolidCube(1); 	glPopMatrix();

	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player1.x + -15,3,player1.y + -1);  glScalef(1,4,1); glutSolidCube(1); 	glPopMatrix();

    glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player1.x + -14,7,player1.y + 1); glScalef(-3,-1,1); glutSolidCube(1); 	glPopMatrix();
...
void Player2(void)
{
	...
	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player2.x + 15,5,player2.y + 0); glScalef(1,4,2); glutSolidCube(1); 	glPopMatrix();

	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player2.x + 15,3,player2.y + 1); glScalef(1,4,1); glutSolidCube(1); 	glPopMatrix();

	glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player2.x + 15,3,player2.y + -1); 	glScalef(1,4,1); glutSolidCube(1); 	glPopMatrix();

    glPushMatrix(); glColor3f(1,1,1); 	glTranslatef(player2.x + 14,7,player2.y + 1); glScalef(-3,-1,1); glutSolidCube(1); 	glPopMatrix();
...
///placar 3d
// funcao que desenha o Placar em 3d
void DesenhaPlacar()
{
    int i=0;
    char placar[70];
    ...
    sprintf(placar, "Gremio %d x %d Inter \0", Placar[0], Placar[1]);
  	glPushMatrix();
